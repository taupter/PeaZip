...
const
  APPLICATION_PEA = 'Pea 1.30 (LGPLv3, Giorgio Tani)';

  {$IFDEF MSWINDOWS}
  EXEEXT        = '.exe';
  UNRARNAME     = 'unrar';
  APPLICATION_7Z = '7z 26.00 (LGPL, Igor Pavlov), and Tino Reichardt sfx modules and codecs 24.09-v1.5.7-R1 (LGPL)';
  {$IFDEF WIN64}
  ...
  APPLICATION_7Z   = 'Linux 7z 26.00 (LGPL, Igor Pavlov), cielavenir/p7zip 24.09.1 (LGPL, T. Yamada)';
  APPLICATION_ZSTD = 'Zstd 1.5.7 (Dual license BSD / GPLv2, Yann Collet, Przemysław Skibiński)';
  {$IFDEF CPUAARCH64}
  APPLICATION_ZPAQ    = '';
  ...
  EXEEXT        = '';
  UNRARNAME     = '';
  APPLICATION_7Z      = 'macOS 7z 26.00 (LGPL, Igor Pavlov), cielavenir/p7zip 24.09.1 (LGPL, T. Yamada)';
  ...
  //Pea 1.30
  HPEA_BSD_X_GTK2     = 'EBAEC0DBCEE53F77958ED021B9E230758065AE693FD2425348FD839BB3079EF2'; //BSD x86_64 GTK2
  HPEA_LIN_A_GTK2     = 'EB2B6B330683A587693FF245EFAF1793B1977E857B3BCBFB8296ECCA679DAFCB'; //lin aarch64 GTK2
  HPEA_LIN_X_GTK2     = 'BD04DAFF8DFBACF0FD2791920DBF1A7A7E648D55D4DE845EB425B357D3545071'; //lin x86_64 GTK2
  HPEA_LIN_X_GTK3     = 'DDF6BCA6F12E75717D26086648D299B76B9EA3332A99F78D5240567A97C576D0'; //lin x86_64 GTK3
  HPEA_LIN_X_QT6      = '74D339496BBC0950F42B89304A0CCDBBE75151B4060FFE71DFA2D038F156CBF6'; //lin x86_64 Qt6
  HPEA_MACOS_A        = '769A35FC121DF01A60BF22C713F503DD1045A5E5E34BBBD2DDA91333D7697281'; //macos aarch64
  HPEA_MACOS_X        = '6595BF58DFEBA66D2B0F4EB68486392CF7D0747F133F964D4925157C051BFE1A'; //macos Intel x86_64
  HPEA_WIN32_X        = '6437BD8641434B44E2953245599ABD3239B98F496B6EF1B4716BA2C0435B84B6'; //win32
  HPEA_WIN64_X        = '41749FE16C719861D9AAB0FC8F7E213A6BB5124EB088B8580DDADBD9D2E093BB'; //win64
  ...
  //7z 26.00
  H7Z_WIN64_X         = '4A41AA37786C7EAE7451E81C2C97458D5D1AE5A3A8154637A0D5F77ADC05E619'; //7z win64
  H7ZDLL_WIN64_X      = 'BBD705E3B58CA7677C1E9E67473F166A6712DA034DCB567D571FBB67507A443F'; //7z\7z.dll win64
  H7Z_WIN32_X         = '2F17553A71AD019D64AD83B79C82C3F824491281C9EF514DAD8006918319E6FF'; //7z win32
  H7ZDLL_WIN32_X      = 'A575175338706D1473E2BEBE1CD811283C63C697A17C0865DE85EDE345898AF6'; //7z\7z.dll win32
  H7Z_LIN_A           = 'DFBFA2424A81C6E7DBE8786ABFA4A3CA038C65FF94DAD5709DA09C4AED4C672D'; //7z aarch64
  H7Z_LIN_X           = '4836193A032A410C3E0F3C177705ED4DA51D4BFB396263ADD6B2D68D79CD518A'; //7z linux x86_64
  H7Z_MACOS           = 'A00F6D085A82A95F6DFC69EA150E05234A12B6D5D134325DDDB964CAE6817488'; //7z macOS universal binary
