...
LicenseFile=C:\input\peazip-10.9.0.WINDOWS\res\share\copying\copying.txt
OutputDir=C:\output\
OutputBaseFilename=peazip-10.9.0.WINDOWS
...
[Files]
Source: "C:\input\peazip-10.9.0.WINDOWS\peazip.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-10.9.0.WINDOWS\pea.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-10.9.0.WINDOWS\dragdropfilesdll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\input\peazip-10.9.0.WINDOWS\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
...
{ Labelinstall1 }
  ...
  begin
    ...
    Items.Add('ZH-CN - Chinese Simplified');
    Items.Add('ZH-HANT - Chinese Traditional');
    ItemIndex := 7;
  end;
...
case combobox1.itemindex of
 ...
 5: slang:='cz.txt';
 6: slang:='de-uml.txt';
 7: slang:='*nochange';//do not change
 8: slang:='en.txt';
 9: slang:='en-gb.txt';
 10: slang:='es-es.txt';
 11: slang:='es-la.txt';
